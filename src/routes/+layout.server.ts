...
export const load: LayoutServerLoad = async (event) => {
	...
	return {
		...
		compactionMode: getSetting('compactionMode') ?? 'threshold',
		compactionTargetPercent: getSetting('compactionTargetPercent') != null ? Number(getSetting('compactionTargetPercent')) : 50,
